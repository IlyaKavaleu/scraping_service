...
def register_view(request):
    ...
    if form.is_valid():
        ...
        new_user.save()
        messages.success(request, 'User append in system.')
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user.save()
                messages.success(request, 'Data success updated.')
...
def delete_view(request):
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            qs.delete()
            messages.error(request, 'User was delete!.')
    return redirect('scraping:home')
...
def contact(request):
    if request.method == 'POST':
        ...
        if contact_form.is_valid():
            ...
            messages.success(request, 'Data send to administration!')
            return redirect('accounts:update')
        else:
            return redirect('accounts:update')
    else:
